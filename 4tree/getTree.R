...
raw.hack <- read.nexus("/fastdata/bo4mhe/run_files/scripts/4tree/Data/RAW/Genus.nexus.Hackett.tre")
...
scaled <- read.tree(paste0("/fastdata/bo4mhe/run_files/scripts/4tree/Data/HACKETT/", traits, "/", traits, "_MeanScaledTree.tre"))
